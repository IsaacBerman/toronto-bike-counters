...
export default function ShareButton({ cityName, citySlug, boundary, bbox, yourPoints, grid, submissionCount, score, frameBbox }) {
  ...
  async function buildFiles() {
    ...
    const canvas = await renderShareCard({ cityName, boundary, bbox, yourPoints, grid, submissionCount, score, frameBbox });
